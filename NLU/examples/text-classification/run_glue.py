...
class ModelArguments:
    ...
    average_initial_rank: Optional[int] = field(
        default=None,
        metadata={"help": "LoRA r"},
    )
    ...
    apply_salientlora: Optional[bool] = field(
        default=True,
    ...
    average_target_rank: Optional[int] = field(
        default=2,
        metadata={"help": "Average target rank."},
    )
    ...
    allocation_step: Optional[int] = field(
        default=4500,
        metadata={"help": "Total steps of inital warmup"},
    )
    ...
    initial_time_window: Optional[int] = field(
        default=10,
        metadata={"help": "Masking interval"},
    )
    final_time_window: Optional[int] = field(
        default=200,
        metadata={"help": "Masking interval"},
    )
    ...
    beta: Optional[float] = field(
        default=0.85,
        metadata={"help": "The correlation threshold. "},
    )
    gamma: Optional[float] = field(
        default=0.85,
        metadata={"help": "The slope threshold for dependency calculation. "},
    )
    lambda_para: Optional[float] = field(
        default=0.85,
        metadata={"help": " The hyperparameter controlling the degree of contribution in salience measurement."},
    )
...
def main():
    ...
    if model_args.lora_type == "svd" and model_args.apply_salientlora:
        rankallocator = RankAllocator(
            model, 
            lora_r=model_args.average_initial_rank,
            target_rank=model_args.average_target_rank,
